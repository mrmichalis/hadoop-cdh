...
curl -L http://apache.mirrors.timporter.net/maven/maven-2/2.2.1/binaries/apache-maven-2.2.1-bin.tar.gz -o apache-maven-2.2.1-bin.tar.gz 
...
curl -L http://mirror.catn.com/pub/apache//ant/binaries/apache-ant-1.9.2-bin.tar.gz -o apache-ant-1.9.2-bin.tar.gz
tar xzvf apache-ant-1.9.2-bin.gz -C /usr/local/ && ln -s /usr/local/apache-ant-1.9.2/ /usr/local/ant
